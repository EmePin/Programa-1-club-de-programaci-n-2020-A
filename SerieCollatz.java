...
{// inicio de la clase
    ...
    public SerieCollatz ()
    {// inicio del método constructor SerieCollatz 
        numero = 0;// inicializamos número con valor 0
        serie = " ";// inicializamos serie con valor de un espacio en blanco jsjs
    
    }//fin del método constructor SerieCollatz 

    public String Serie(int numero)
    {//inicio del método Serie con el parámetro tipo enterro número
        ...
        if(numero > 0){// inicio del if con condición que acepta sólo números naturales es decir enteros positivos
